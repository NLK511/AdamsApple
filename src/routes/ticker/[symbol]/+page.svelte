<script lang="ts">
  ...
  const updateEngineSelection = (kind: 'entry' | 'fundamental', event: Event) => {
  ...
  <section class="panel controls">
    <div>
      ...
      <select id="fundamental-engine"
        ...
        on:change={(event) => updateEngineSelection('fundamental', event)}>
    ...
    <div>
      ...
      <select id="entry-engine"
        ...
        on:change={(event) => updateEngineSelection('entry', event)}>
