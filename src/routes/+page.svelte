            ...
            <tbody>
              {#each selectedWatchlist.tickers as ticker}
                <tr>
                  ...
                  >
                  <td>
                    <a href={`/ticker/${ticker.symbol}/sentiment?context=${activeContextId}#news`} target="_blank" rel="noopener noreferrer">{ticker.sentimentNewsScore.toFixed(1)}</a>
                    /
                    <a href={`/ticker/${ticker.symbol}/sentiment?context=${activeContextId}#social`} target="_blank" rel="noopener noreferrer">{ticker.sentimentSocialScore.toFixed(1)}</a>
                  </td>
                  <td>
                    <div class="alerts">
